...
const Login = () => {
    return (
        <div className='h-screen w-full flex items-center bg-slate-100'>
            <div className='flex shadow-lg lg:w-2/5  h-96 m-auto sm:w-2/3'>
                <div className='bg-white p-6 sm:w-3/5 w-full text-center h-full'>
                    ...
                    <form className='flex flex-col gap-4 h-full'>
                        ...
                        <div className='flex justify-end items-center flex-col gap-2'>
                            ...
                            <Link to='/register' className='sm:hidden block px-4 py-1 bg-blue-500 w-fit rounded text-white'>Sign Up</Link>
                        </div>
                    </form>
                </div>
                <div className='hidden sm:flex justify-center items-center bg-blue-600 text-white flex-col p-6 sm:w-2/5 '>
                    ...
                    <Link className='px-4 py-1 bg-white w-fit rounded  text-black mt-3' to='/register'>Sign Up</Link>
                </div>
            </div>
        </div>
    );
